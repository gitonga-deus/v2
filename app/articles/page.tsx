...
function ArticleCard(article: Article) {
	...
	return (
		<Link
			key={slug}
			className="block select-none p-2 my-2 -mx-2 rounded-md duration-500 transition-colors hover:bg-links-h-bg"
			href={`/articles/${slug}`}
		>
			<div className="flex py-1 items-center text-shade-1 gap-2 text-sm tracking-tight">
			...
			<h2 className="py-1 text-shade-1 text-base font-semibold leading-6 tracking-tight">{title}</h2>
...
export default function Page() {
	...
	return (
		<section className='py-4'>
			<h1 className="font-bold text-gitonga-bg tracking-tight text-2xl mb-1">Articles</h1>
